        ...
        return(
            <div className='header-top-container'>
                <div className='container header-top'>
                    <div 
                    className={`header-top-description`}>
                    ...
                    <div className={`header-top-img ${this.state.loadImg ? 'load' : ' '}`}>
                        <img 
                            src="https://res.cloudinary.com/dofq7q8oh/image/upload/v1574435060/slider2.png"
                            alt="Bag with hand"
